        ...
        <table style="width: 100%; margin: 0px;" role="presentation" border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td>&nbsp;</td>
                    <td align="left">
                        <p style="text-align: center;"><strong>DEBIT NOTIFICATION</strong></p>
                    </td>
                    <td align="left">&nbsp;</td>
                </tr>
            </tbody>
                                                            ...
                                                            <tr style="height: 20px;">
                                                                <td style="font-size: 0px; padding: 10px 25px; word-break: break-word; height: 20px;"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0;">We like to inform you that
                                                                            NGN {{ number_format($data1["amount"], 2) }}
                                                                            has left your account to {{
                                                                            $data1["receiver"]}}</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                            ...
                                            <td style="font-size: 0px; padding: 10px 25px; word-break: break-word;"
                                                ...
                                                <div
                                                    ...
                                                    Thanks for choosing ENKPAY, you can <a
                                                        ...
                                                        href="https://google.com"> unsubscribe </a>from all future
                                                    emails.</div>
                                            </td>
                                        </tr>
                                    </tbody>
