                    ...
                    <div class="card mt-5"
                        ...
                        <div class="card-body" style="text-align: center;background: #000000;border-radius: 300px;">
                            <img src="{{ url('') }}/public/assets/img/idimage.png" height="100" width="100"
                                ...
                                <h4 class="card-title"
                                style="font-size: 13.48px;padding-top: 28px;color: var(--bs-card-bg);">Verify Your ID
                                for Added Security</h4>
                            ...
                            <form action="upload-id" method="get">
                                ...
                                <button class="btn btn-primary" type="submit"
                                    style="color: rgb(0,0,0);background: rgb(255,199,0);font-size: 13px;margin-top: 16px;margin-bottom: 24px;border-style: none;">Start
                                    verification&nbsp;</button>
